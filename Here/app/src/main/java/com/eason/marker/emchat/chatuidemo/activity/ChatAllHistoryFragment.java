...
//		});
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		// 更新消息未读数
		((EMChatMainActivity) getActivity()).updateUnreadLabel();
	...
	public void onResume() {
		super.onResume();
		if (!hidden && ! ((EMChatMainActivity)getActivity()).isConflict) {
			refresh();
		}
	}
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((EMChatMainActivity)getActivity()).isConflict){
        	outState.putBoolean("isConflict", true);
        }else if(((EMChatMainActivity)getActivity()).getCurrentAccountRemoved()){
