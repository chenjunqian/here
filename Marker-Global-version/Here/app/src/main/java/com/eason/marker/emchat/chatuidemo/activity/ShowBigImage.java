...
import com.eason.marker.emchat.chatuidemo.task.LoadLocalBigImgTask;
import com.eason.marker.emchat.chatuidemo.utils.ImageCache;
import com.eason.marker.emchat.chatuidemo.widget.photoview.PhotoView;
import com.eason.marker.emchat.chatuidemo.widget.photoview.PhotoViewAttacher;
...
public class ShowBigImage extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.drawable.default_avatar_ori);
